...
import {clearCart, deletePizza, minusCartItem, plusCartItem, setOrderConfirmation} from "../redux/actions/cart";
...
function Cart() {
    ...
    const makeOrder = () => {
        dispatch(setOrderConfirmation(true))
        if(!isAuth){
            dispatch(visibleLoginForm(true))
            return
        }
                ...
                ? (<div className="cart">
                    ...
                    <div className="cart__bottom">
                        ...
                        <div className="cart__bottom-buttons">
                            ...
                            <div onClick={() => makeOrder(addedPizzas)} className="button pay-btn">
